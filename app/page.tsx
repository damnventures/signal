...
export default function Home() {
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-4 sm:p-8 md:p-20 pb-20 gap-8 sm:gap-16 bg-gray-100 dark:bg-gray-900">
      <style jsx global>{`
        @font-face {
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center w-full max-w-2xl">
        ...
        <div className="w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-md overflow-hidden">
          {/* OS Window Top Bar */}
        ...
        <Image
          ...
          priority
        />
        <ol className="font-mono list-inside list-decimal text-sm sm:text-base text-center sm:text-left">
